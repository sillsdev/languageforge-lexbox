...
<div class="project-view !flex flex-col PortalTarget" style={spaceForEditorStyle}>
  ...
  <main bind:this={editorElem} class="p-4 flex grow">
    ...
    >
      ...
      <div class="max-w-full w-screen lg-view:w-screen collapsible-col" class:lg-view:px-6={!expandList} class:sm-view:pr-6={pickedEntry && !readonly} class:lg-view:collapse-col={expandList} class:sm-view:collapse-col={!pickedEntry}>
        {#if $selectedEntry}
