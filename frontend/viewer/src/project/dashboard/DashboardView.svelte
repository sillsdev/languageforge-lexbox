<script lang="ts">
  ...
  import {useDashboardStats, type FieldCompletion} from '$project/data/dashboard-stats';
  ...
  const fieldStatGridClass = 'grid gap-y-3 gap-x-1.5 text-sm grid-cols-[1fr_14px_minmax(5.5rem,auto)]';
</script>
...
{#snippet fieldStatRow(
  ...
  <div class="grid grid-cols-subgrid col-span-full items-center">
    ...
    <div class="{wsColorClass} leading-none">
