<script lang="ts">
  ...
  import {ENTRY_OPEN_PARAM} from '$lib/utils/search-params';
  ...
  const entryOpen = new QueryParamStateBool({key: ENTRY_OPEN_PARAM, allowBack: IsMobile.value, replaceOnDefaultValue: IsMobile.value}, false);
