...
export function isEntry(data: IEntry | ISense | IExampleSentence): data is IEntry {
  return !isSense(data) && !isExample(data);
}

export function isSense(data: IEntry | ISense | IExampleSentence): data is ISense {
  if (data === undefined) return false;
  return 'entryId' in data;
}

export function isExample(data: IEntry | ISense | IExampleSentence): data is IExampleSentence {
  if (data === undefined) return false;
