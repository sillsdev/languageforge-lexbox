...
import type {IEntriesWindow} from '../../MiniLcm/Models/IEntriesWindow';
...
export interface IMiniLcmJsInvokable
{
	...
	getEntriesWindow(query?: string, options?: IQueryOptions, targetEntryId?: string) : Promise<IEntriesWindow>;
	getEntryIndex(entryId: string, query?: string, options?: IFilterQueryOptions) : Promise<number>;
