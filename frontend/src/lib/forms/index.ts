...
import { superForm, type EnhancedForm, type FormOptions } from 'sveltekit-superforms/client';
...
export function lexSuperForm<S extends AnyZodObject>(schema: S, options: Omit<FormOptions<S, string>, 'validators'> = {}): EnhancedForm<S, string> {
	return superForm(undefined, {validators: schema, ...options});
}
