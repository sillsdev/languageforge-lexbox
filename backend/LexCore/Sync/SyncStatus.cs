...
{
    public static ProjectSyncStatus NeverSynced => new(ProjectSyncStatusEnum.NeverSynced, 0, 0, DateTimeOffset.UnixEpoch, DateTimeOffset.UnixEpoch);
    public static ProjectSyncStatus Syncing => new(ProjectSyncStatusEnum.Syncing, 0, 0, DateTimeOffset.UnixEpoch, DateTimeOffset.UnixEpoch);
