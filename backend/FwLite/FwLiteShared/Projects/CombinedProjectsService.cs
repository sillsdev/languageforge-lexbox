    ...
    OAuthClientFactory oAuthClientFactory)
{
    ...
    {
        // Note: the local project might be from a different server, but that's currently only relevant
        // for devs and we still can't download two projects with the same code
