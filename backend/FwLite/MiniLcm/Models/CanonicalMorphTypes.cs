...
public static class CanonicalMorphTypes
{
    ...
    private static readonly FrozenSet<Guid> CanonicalIds = All.Values.Select(m => m.Id).ToFrozenSet();

    public static bool IsCanonical(Guid id)
    {
    ...
    private static MorphType[] CreateAll()
    {
        ...
        [
            ...
            new()
            {
                ...
                Description = new RichMultiString { { "en", new RichString("An enclitic is a clitic that is phonologically joined at the end of a preceding word to form a single unit. Orthographically, it may attach to the preceding word.") } },
                Prefix = "=",
                SecondaryOrder = 80,
            },
            new()
            ...
            new()
            {
                ...
                Description = new RichMultiString { { "en", new RichString("A proclitic is a clitic that precedes the word to which it is phonologically joined. Orthographically, it may attach to the following word.") } },
                Postfix = "=",
                SecondaryOrder = 30,
            },
            new()
            {
                ...
                Description = new RichMultiString { { "en", new RichString("A root is the portion of a word that (i) is common to a set of derived or inflected forms, if any, when all affixes are removed, (ii) is not further analyzable into meaningful elements, being morphologically simple, and, (iii) carries the principal portion of meaning of the words in which it functions.") } },
                SecondaryOrder = 0,
            },
            new()
            {
            ...
            new()
            {
                ...
                Description = new RichMultiString { { "en", new RichString([
                    new RichSpan { Text = "\"A stem is the root or roots of a word, together with any derivational affixes, to which inflectional affixes are added.\" (LinguaLinks Library). A stem \"may consist solely of a single root morpheme (i.e. a 'simple' stem as in " },
                    new RichSpan { Text = "man", NamedStyle = "Emphasized Text" },
                    new RichSpan { Text = "), or of two root morphemes (e.g. a 'compound' stem, as in " },
                    new RichSpan { Text = "blackbird", NamedStyle = "Emphasized Text" },
                    new RichSpan { Text = "), or of a root morpheme plus a derivational affix (i.e. a 'complex' stem, as in " },
                    new RichSpan { Text = "manly", NamedStyle = "Emphasized Text" },
                    new RichSpan { Text = ", " },
                    new RichSpan { Text = "unmanly", NamedStyle = "Emphasized Text" },
                    new RichSpan { Text = ", " },
                    new RichSpan { Text = "manliness", NamedStyle = "Emphasized Text" },
                    new RichSpan { Text = "). All have in common the notion that it is to the stem that inflectional affixes are attached.\" (Crystal, 1997:362)" },
                ]) } },
                SecondaryOrder = 0,
            },
            new()
            ...
            new()
            {
                ...
                Description = new RichMultiString { { "en", new RichString("A suffixing interfix is a suffix that can occur between two roots or stems.") } },
                Prefix = "-",
                SecondaryOrder = 0,
            },
            new()
