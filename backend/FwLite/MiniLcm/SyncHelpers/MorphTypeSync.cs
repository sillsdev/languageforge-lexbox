...
public static class MorphTypeSync
{
    ...
    {
        if (beforeMorphType.Kind != afterMorphType.Kind)
        {
            throw new InvalidOperationException(
                $"Tried to change immutable Kind from {beforeMorphType.Kind} to {afterMorphType.Kind} on MorphType {afterMorphType.Id}. This indicates a data inconsistency.");
        }
