...
public class EntryFilterMapProvider : EntryFilterMapProvider<Entry>
{
    ...
    public override Expression<Func<Entry, object?>> EntrySensesExampleSentences => e => e.Senses.Select(s => s.ExampleSentences.Where(e => Json.QueryValues(e.Sentence).Any(v => !string.IsNullOrWhiteSpace(v))));
