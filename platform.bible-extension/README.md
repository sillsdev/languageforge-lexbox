...
1. In `platform.bible-extension/`, run `task build-fw-lite` then `npm run build:production`.

2. Move or copy the contents of `platform.bible-extension/dist/` into `paranext-core/dev-appdata/installed-extensions/lexicon/`.
